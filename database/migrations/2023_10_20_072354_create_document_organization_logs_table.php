...
return new class extends Migration
{
    ...
    {
        Schema::create('document_organization_logs', function (Blueprint $table) {
            $table->id();

            $table->integer('document_id')->nullable(false)->unsigned();
            $table->integer('organization_id')->nullable(false)->unsigned();
        ...
        Schema::table('document_organization_logs',
        function($table)
        {
    ...
    {
        Schema::dropIfExists('document_organization_logs');
    }
};
