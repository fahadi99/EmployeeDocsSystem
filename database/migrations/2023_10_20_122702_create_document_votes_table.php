...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('document_votes', function (Blueprint $table) {
            ...
            $table->integer('vote_type_id')->nullable(false)->unsigned();
        ...
        Schema::table('document_votes',
        function($table)
        {
            $table->foreign('document_id')->references('id')->on('documents')->onDelete('cascade');
            $table->foreign('vote_type_id')->references('id')->on('voting_types')->onDelete('cascade');
