                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="flex-row-fluid ml-lg-8">
                                <div class="card card-custom card-stretch">
                                    ...
                                    <!--begin::Form-->
                                    {{-- <form class="form">  --}}
                                        {!! Form::open(['action','MemberController@change_admin_password','id'=>'change_password_form','class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data','files'=>true]) !!}
                                        <!--begin::Body-->

                                        {{ Form::hidden('member_id',isset($data)?$data->member_id:null, array('id' => 'member_id')) }}
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
       ...
       $('body').on('click', '#update-password', function (event) {
        ...
        var form_data = new FormData(document.getElementById("change_password_form"));
            ...
            $.ajax({
                    data: form_data,
                    url: "{{ route('change_admin.password', ['id' => $data->member_id ])}}",
                    type: "POST",
                    dataType: 'json',
                    cache:false,
                    contentType: false,
