        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="example d-flex align-items-center flex-wrap mr-2">
                    @include('include.Document_Menue')
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="row" id="organizations_listing">
                    @include('document-category.include.document-category_grid', ['data' => $data])
                </div>
            </div>
            <!--end::Container-->
        </div>
            ...
            <div class="modal-dialog  modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="add-organization-button" class="btn btn-primary font-weight-bold">Add Document</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    $('#search_by_name').keydown(function (event) {
       ...
       $('body').on('click', '#add-organization-button', function (event) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('document-categories.add')}}",
                    type: "POST",
                    dataType: 'json',
                    success: function (data) {
                        if(data.status === 200){
        ...
        $('body').on('click', '#update-organization-button', function (event) {
             ...
             $('body').on('click', '#organization-delete', function (event) {
                ...
                $.ajax({
                        type: "delete",
                        url: SITEURL + "/document-categories/delete/"+id,
                        success: function (data) {
                                if(data.status === 200){
                                    var message = data.message;
                                    $("#kt_content").load(location.href + " #kt_content>*", "");
