        ...
        <div class="card-header border-0 pr-3 ribbon ribbon-clip ribbon-left">
            ...
            <div class="card-toolbar">
                @if(checkPersonPermission('update-type-3-0'))
                    <a href="#" class="btn btn-icon btn-sm btn-hover-light-primary" id="type-edit" data-id="{{$row['id']}}" data-toggle="modal" data-placement="top" title=""  data-target="#exampleModal2">
                        <i class="fas fa-pencil-alt"></i>
                    </a>
                @endif
                @if(checkPersonPermission('delete-type-3-0'))

                    <a href="#" class="btn btn-icon btn-sm btn-hover-light-primary mr-1" id="type-delete" data-id="{{$row['id']}}" data-toggle="modal" data-placement="top" title="" data-target="#exampleModal3">
