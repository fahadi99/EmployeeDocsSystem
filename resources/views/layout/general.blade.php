...
<head><base href="">
    ...
    <link href="{{URL::to('assets/plugins/custom/prismjs/prismjs.bundle.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{URL::to('assets/css/style.bundle.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{URL::to('assets/css/custom.bundle.css')}}" rel="stylesheet" type="text/css" />
    <link rel="shortcut icon" href="{{asset('images/hrldigital.ico')}}"/>
        ...
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
            ...
            <div id="kt_header" class="header header-fixed">
                ...
                <div class="container-fluid d-flex align-items-stretch justify-content-between">
                    ...
                    @include('layout.partial.page.header-left')
...
<script src="{{URL::to('assets/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}"></script>
    <script src="{{URL::to('assets/js/pages/features/calendar/external-events.js')}}"></script>
...
<script src="{{URL::to('assets/js/pages/widgets.js')}}"></script>
<!--end::Page Scripts-->
...
<script src="{{URL::to('assets/js/pages/features/cards/tools.js')}}"></script>

<script src="{{URL::to('assets/js/pages/crud/forms/widgets/select2.js')}}"></script>
<script src="{{URL::to('assets/js/pages/crud/forms/widgets/bootstrap-switch.js')}}"></script>
