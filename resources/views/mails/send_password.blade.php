            ...
            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 33px;font-family:'Montserrat',sans-serif;" align="left">
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                        <p style="Margin-top: 20px;Margin-bottom: 0;">{{ $data['name'] }} Welcome {{ $data['name'] }}. </p>
                        <p style="Margin-top: 20px;Margin-bottom: 0;">Your account has been created at <a href="{{url('login')}}">{{config('app.name')}}</a> and temporary password is also generated.</p>
                      <p style="Margin-top: 20px;Margin-bottom: 0;">Email : {{ $data['email'] }}</p>
                      <p style="Margin-top: 20px;Margin-bottom: 0;">Password : {{ $data['password'] }}</p>
                      <br>
                      <p style="Margin-top: 20px;Margin-bottom: 0;">Message : {{ $data['message'] }}</p>
                      <p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;</p><p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;</p>
                    </div>
                  </div>
...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="background-color: #4b5462;background: 0px 0px/auto auto repeat url(https://i1.createsend1.com/ei/t/2F/D80/229/202837/csfinal/header-img361.jpg) #4b5462;background-position: 0px 0px;background-image: url(https://i1.createsend1.com/ei/t/2F/D80/229/202837/csfinal/header-img361.jpg);background-repeat: repeat;background-size: auto auto;">
        <div class="layout one-col stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
          <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
      ...
      <div style="mso-line-height-rule: exactly;line-height: 50px;font-size: 1px;">&nbsp;</div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <h2 style="Margin-top: 0;Margin-bottom: 16px;font-style: normal;font-weight: normal;color: #e31212;font-size: 26px;line-height: 34px;font-family: Avenir,sans-serif;text-align: center;"><strong>Temporary password Sent from HRL</strong></h2>
      </div>

      <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
          <p style="Margin-top: 20px;Margin-bottom: 0;">{{ $data['name'] }} your temporary password is generated successfully </p>
          <p style="Margin-top: 20px;Margin-bottom: 0;">Email : {{ $data['email'] }}</p>
          <p style="Margin-top: 20px;Margin-bottom: 0;">Password : {{ $data['password'] }}</p>
          <br>
          <p style="Margin-top: 20px;Margin-bottom: 0;">Message : {{ $data['message'] }}</p>
