...
<head><base href="../../../">
    <meta charset="utf-8" />
    <title>Permission Denied - Employee Portal | SmartOne</title>
...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{url('assets/media/error/bg6.jpg')}});">
        <!--begin::Content-->
        <div class="d-flex flex-column flex-row-fluid text-center">
            <h1 class="error-title font-weight-boldest text-white mb-12" style="margin-top: 12rem;">403</h1>
            <p class="display-4 font-weight-bold text-white">Permission Denied. <a href="{{url('/')}}" class="text-white font"><u>Click here to continue</u></a></p>
        </div>
        <!--end::Content-->
    </div>
    <!--end::Error-->
