                ...
                <div class="card card-custom card-stretch ">
                    ...
                    <div class="card-header pt-5 pb-10">
                        <div class="card-title align-items-start flex-column">
                            <h3 class="card-label font-weight-bolder text-dark">Survey Questions</h3>
                        ...
                        <div class="card-toolbar">
                            <a class="btn btn-light-primary font-weight-bold ml-2 mr-2" data-toggle="modal" data-target="#exampleModal">Add Question</a>
                            <a href="{{route('survey.questions.sort', ['id' => $survey->id])}}" class="btn btn-light-secondary text-dark-75 font-weight-bold ml-2">Sort Questions</a>
                        </div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Form-->

                    @include('survey.questions.include.grid', ['questions' => $survey->questions])
                </div>
            </div>
            <!--end::Content-->
        </div>
