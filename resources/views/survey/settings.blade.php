                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="flex-row-fluid ml-lg-8" >
                                <div class="card card-custom card-stretch">
                                    ...
                                    <!--end::Header-->
                                    <!--begin::Form-->
                                    {!! Form::open(['action','MemberController@change_settings','id'=>'change_settings_form','class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data','files'=>true]) !!}
                                        <!--begin::Body-->
                                        <div class="card-body" >
    ...
    $.ajaxSetup({
      ...
      'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
       ...
       $('body').on('click', '#save_settings_changes', function (event) {
            ...
            $.ajax({
                    data: form_data,
                    url: "{{ route('change_member.settings')}}",
                    type: "POST",
                    dataType: 'json',
                    cache:false,
                    contentType: false,
