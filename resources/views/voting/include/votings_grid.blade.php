...
<div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-5  ">
    <div class="card card-custom pl-2 pt-5 pb-5" id="kt_card_1">
        <div class="card-header border-0 pr-3 ribbon ribbon-clip ribbon-left">
            <div class="ribbon-target" style="top: 15px; height: 45px; z-index:0">
                <!-- @if($row['parent_id'] == 0)
            ...
            <div class="card-title w-70 max-w-70" style="word-break : break-all">
                ...
                {{-- <h3 class="card-label">{{$row['icon_path']}} --}}
                </h3>
            </div>
            <div class="card-toolbar">
                @if(checkPersonPermission('update-voting-3-0'))
                    <a href="#" class="btn btn-icon btn-sm btn-hover-light-primary" id="voting-edit" data-id="{{$row['id']}}" data-toggle="modal" data-placement="top" title=""  data-target="#exampleModal2">
                        <i class="fas fa-pencil-alt"></i>
                    </a>
                @endif
                @if(checkPersonPermission('delete-voting-3-0'))

                    <a href="#" class="btn btn-icon btn-sm btn-hover-light-primary mr-1" id="voting-delete" data-id="{{$row['id']}}" data-toggle="modal" data-placement="top" title="" data-target="#exampleModal3">
